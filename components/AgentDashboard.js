...
const AgentDashboard = () => {
  return (
    <div className="flex">
      <div className="relative min-h-screen w-36">
        ...
        <div className="flex flex-col my-6">
          <img src="/log.png" alt="" className="w-3/5 mx-auto" />
        ...
        <div className="absolute flex items-center justify-center bottom-4 left-5">
          <img src="/log.png" alt="" className="w-8" />
        ...
        <div className="flex">
          <div className="flex flex-col w-1/4 p-2 m-2 text-green-800">
            ...
            <div className="relative p-2 rounded-lg shadow-xl h-80 bg-green-50">
              ...
              <a className="absolute right-4 bottom-4">A</a>
            </div>
          </div>
          <div className="">
